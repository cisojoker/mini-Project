        ...
        <>
            <motion.div
                ...
                <div className="input">
                    ...
                    <input className='bg-[rgba(255,255,255,0.2)] text-white outline-none p-3 pl-12 pr-6 lg:w-[40%] mt-6 mb-10 rounded-full' type="text" name="query" id="query" placeholder='Search for a video' title='Start Typing' />
                </div>
