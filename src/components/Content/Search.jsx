...
const Search = () => {
  ...
  return (
    <>
      ...
      >
        <h1 className="text-7xl font-extrabold text-white font-jost">
          Neuro
          <span className="text-transparent bg-clip-text bg-gradient-to-r from-pink-500 to-violet-500">
            Calm
          </span>
        </h1>
        <h3 className="text-white text-sm font-light font-jost my-3">
          Detect using ML Models
        </h3>
        <div className="input">
          <FontAwesomeIcon
            className="relative text-white left-8"
            icon={faSearch}
          />
          <input
            className="bg-[rgba(255,255,255,0.2)] text-white outline-none p-3 pl-12 pr-6 lg:w-[40%] mt-6 mb-10 rounded-full"
            type="text"
            name="query"
            id="query"
        ...
        >
          ...
          >
            <span
              className={`relative font-roboto text-lg transition-all duration-500`}
            >
              Trending
            </span>
          </motion.button>
