        ...
        <motion.div
            ...
            <div className={`contact relative transition-all duration-1000  backdrop-blur-3xl z-10 lg:top-24 top-10 lg:flex border border-[rgba(255,255,255,0.1)] bg-[rgba(255,255,255,1)] shadow-2xl shadow-black rounded-2xl m-1 lg:p-8 lg:mx-32`}>
                <div className="details space-y-8 p-6 lg:w-1/2">
                    ...
                    <p className={`text-xl font-medium`}>Thank you for visiting our website! If you have any questions, concerns, or feedback, please don&apos;t hesitate to reach out to us. We are dedicated to providing you with excellent customer service and support.</p>
                </div>
                <div className="form p-6 lg:p-0 lg:w-1/2">
                    ...
                    <form className='flex pt-8 pb-5 space-y-6 flex-col' action="https://formsubmit.co/clipsurf.developers@gmail.com" method='post'>
